 ...
 * This file demonstrates how to integrate Bloomxeno with a web frontend
 */

// For React/Vue/Angular applications
export class BloomxenoClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new BloomxenoClient(provider, contractAddress);
